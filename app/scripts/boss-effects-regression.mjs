...
assert.match(ui, /Debuffs & effects/);
assert.match(ui, /What does uptime mean\?/);
assert.match(ui, /Who applied it/);
assert.match(ui, /Source not recorded in the log/);
assert.match(ui, /All effects on enemies/);
assert.match(ui, /Debuffs & effects on players/);
assert.match(ui, /Immune \/ resisted effect attempts/);
assert.match(ui, /Armor Break/);
assert.match(ui, /Dulled Senses/);
assert.match(ui, /Vulnerability/);
assert.match(ui, /Weapon Break/);
